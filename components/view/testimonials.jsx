...
export const Testimonials = ({ texts }) => {
  const testimonials = [
    {
      testimonialText: texts.testimonialOneText,
      testimonialName: texts.testimonialOneName,
      testimonialRole: texts.testimonialOneRole,
    },
    {
      testimonialText: texts.testimonialSecondText,
      testimonialName: texts.testimonialSecondName,
      testimonialRole: texts.testimonialSecondRole,
    },
    {
      testimonialText: texts.testimonialThirdText,
      testimonialName: texts.testimonialThirdName,
      testimonialRole: texts.testimonialThirdRole,
    },
    {
      testimonialText: texts.testimonialFourthText,
      testimonialName: texts.testimonialFourthName,
      testimonialRole: texts.testimonialFourthRole,
    },
  ];

  return (
    <section id="testimonial" className="pt-[120px] pb-20 dark:bg-night">
      <div className="container">
        ...
        <div className="flex flex-wrap -mx-4">
          {testimonials.map((testimonial, i) => {
            return (
              <div className="w-full lg:w-1/2 px-4" key={`${testimonial.testimonialText}-${i}`}>
                <div className="bg-white dark:bg-grey rounded-xl relative overflow-hidden px-7 sm:px-10 p-10 shadow-testimonial mb-10">
                  <div className="mb-5">
                    <Image
                  ...
                  <p className="font-medium text-lg text-body-color dark:text-white mb-8">
