    ...
    >
      <div className="container">
        <div className="flex flex-wrap sm:mx-4">
          <div className="w-full lg:w-5/12 sm:px-4">
            <div className="hero-content">
              <h1 className="text-dark dark:text-white font-bold text-subtitle sm:text-[40px] lg:text-[39px] leading-tight mb-2">
                {texts.title}
              </h1>
              <h1 className="text-dark dark:text-white font-bold text-subtitle sm:text-[40px] lg:text-[39px] leading-tight mb-3">
                {texts.titleTwo}
              </h1>
              <p className="text-mobile leading-loose mb-2 text-dark dark:text-white max-w-[480px]">
                {texts.description}
              </p>
              <p className="text-mobile leading-loose mb-8 text-dark dark:text-white max-w-[480px]">
          ...
          <div className="w-full lg:w-6/12 px-4">
            <div className="lg:text-right lg:ml-auto">
              <div className="relative inline-block z-10 pt-11 lg:pt-0">
                <Image className="rounded" src="/me.jpg" alt="hero" width="500" height="350" />
                <HeroGridDecoration />
              </div>
            </div>
          </div>
